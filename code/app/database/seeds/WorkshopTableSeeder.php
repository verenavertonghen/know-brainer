        ...
        DB::table('kb_workshops')->insert(
            array(
                array(
                    ...
                    'date'     => DateTime::createFromFormat('d/m/Y', '22/04/2015'),
                    'time'      => DateTime::createFromFormat('H:i','12:00'),
                    'duration'  => DateTime::createFromFormat('i','60'),
                ...
                array(
                    ...
                    'date'     => DateTime::createFromFormat('d/m/Y', '22/12/2014'),
                    'time'      => DateTime::createFromFormat('H:i','12:00'),
                    'duration'  => DateTime::createFromFormat('i','60'),
                ...
                array(
                    ...
                    'date'     => DateTime::createFromFormat('d/m/Y', '22/11/2014'),
                    'time'      => DateTime::createFromFormat('H:i','12:00'),
                    'duration'  => DateTime::createFromFormat('i','60'),
